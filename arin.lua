...
local randommsgs = {
    ...
    'my fish died today',
    'personally i think you should donate',
    'what are your opinions on joe',
    'can you donate so that I can feed my family',
    'please donate i need vc perms',
    'please donate i have no money',
    'please give me shelter',
    'i want to be cared for',
    'my father left me at a young age',
    'PLEASE SOMEONE HELP ME GET MY GOAL',
    ':D',
    ':)',
    ':(',
    ':-)',
...
if game:GetService("CoreGui").imgui.Windows.Window.Title.Text == "Loading..." then
	game:GetService("CoreGui").imgui.Windows.Window.Title.Text = "Modified by TheTrueLando | 1/7/2023"
end
